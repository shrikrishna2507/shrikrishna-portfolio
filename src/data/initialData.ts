...
export const initialProfileData: ProfileData = {
  ...
  tagline: 'Computer Science Engineering student at MITE with strong fundamentals in Full-Stack Web Development, Database Management, Data Structures, and Software Engineering.',
  ...
  bio: 'Enthusiastic and detail-oriented Computer Science Engineering student with strong skills in web development, database management, and software engineering. Eager to leverage technical expertise to contribute to innovative engineering projects.',
  profilePic: '/profile_suit.jpg',
  skills: {
    languages: ['C', 'Java', 'Python', 'SQL'],
    webDev: ['React.js', 'Node.js', 'Express.js', 'HTML5', 'CSS3', 'JavaScript', 'Bootstrap'],
    databases: ['MySQL', 'MongoDB'],
    mlAi: ['Machine Learning Basics', 'OpenCV (Project Use)', 'Predictive Modeling'],
  ...
  achievements: [
    ...
    },
    {
      ...
      category: 'Language',
      rank: 'First Class',
      description: 'Successfully completed Prathama examination conducted by Dakshina Bharat Hindi Prachar Sabha securing First Class.',
      year: '2022',
    ...
    },
    {
      ...
      category: 'Language',
      rank: 'Second Class',
      description: 'Successfully completed Madhyama examination conducted by Dakshina Bharat Hindi Prachar Sabha securing Second Class.',
      year: '2022',
